...
public final class UserListItemBinding implements ViewBinding {
  ...
  private UserListItemBinding(@NonNull ConstraintLayout rootView, @NonNull TextView message,
  ...
  public static UserListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new UserListItemBinding((ConstraintLayout) rootView, message, userName);
    }
